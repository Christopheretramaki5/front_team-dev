    ...
    <header className="flex items-center justify-between p-3 bg-white shadow-md relative">
      ...
      <div className="flex items-center space-x-6 ml-4 relative">
        ...
        <div className="relative" ref={notificationRef}>
          <div className="w-8 h-8 flex items-center justify-center bg-gray-200 shadow-md rounded-lg cursor-pointer hover:bg-gray-300" onClick={toggleNotificationMenu}>
          ...
          {isNotificationMenuOpen && (
            <div className="absolute right-0 mt-2 min-w-[12rem] bg-white border rounded-lg shadow-lg py-2 z-50">
              ...
              {notifications.map((notification) => (
                <div key={notification.id} className="w-full flex items-center px-4 py-2 text-sm hover:bg-gray-100">
                  <img src={notification.senderImage} alt="Sender" className="w-6 h-6 rounded-full mr-2" />
